...
//        CSignalFactory::single_reverb_chord(261.63, 329.63, 392.00),
        ...
        CSignalFactory::bell_thingy(noteC6),
//        CSignalFactory::bell_thingy(noteDb6),
        CSignalFactory::bell_thingy(noteD6),
//        CSignalFactory::bell_thingy(noteEb6),
        CSignalFactory::bell_thingy(noteE6),
        CSignalFactory::bell_thingy(noteF6),
//        CSignalFactory::bell_thingy(noteGb6),
//        CSignalFactory::bell_thingy(noteG6),
        CSignalFactory::reverb_string(noteC5),
